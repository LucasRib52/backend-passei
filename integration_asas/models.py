...
class AsaasPayment(models.Model):
    ...
    pix_qr_code = models.TextField(blank=True, verbose_name='QR Code PIX (Imagem Base64)')
    pix_code = models.TextField(blank=True, verbose_name='Código PIX (Código Copiável)')

...
class AdminCourseViewSet(generics.ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        print("🔍 DEBUG - Dados recebidos na criação:", request.data)
        print("🔍 DEBUG - themembers_product_id:", request.data.get('themembers_product_id'))
...
class AdminCourseDetailView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def update(self, request, *args, **kwargs):
        print("🔍 DEBUG - Dados recebidos na atualização:", request.data)
        print("🔍 DEBUG - themembers_product_id:", request.data.get('themembers_product_id'))
